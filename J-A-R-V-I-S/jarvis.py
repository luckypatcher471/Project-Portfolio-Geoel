...
def listen_to_command():#Speech to Text.
...
def generate_response(query):#Generate a response for the given query using Gemini.
    try:
        ...
        temperature=0.5,))
        print("\n")
        #response = genai.generate_text(prompt=f"User: {query}\nJarvis:")
