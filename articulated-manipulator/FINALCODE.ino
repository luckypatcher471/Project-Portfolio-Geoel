...
Servo servos[5];
int servoPins[5] = {D5, D7, D6, D3, D4};  // Servo 2 moved from D1 to D7

// Min and Max angle limits for each servo
int minAngles[5] = {40, 40, 20, 20, 50};  
int maxAngles[5] = {150, 170, 160, 170, 120};  
        ...
        request->send(200, "text/html", R"rawliteral(
            ...
            <body>
                ...
                <div class="container">
                    ...
                    <div class="slider-container">
                        <h3>Servo 2 (D7): <span id="angle1">90</span>°</h3>
                    ...
                    <div class="slider-container">
                        ...
                        <input type="range" min="50" max="120" value="90" id="slider4" oninput="updateServo(4, this.value)">
                    </div>
                </div>
                <script>
